...
from mai_ui_tech.coords import SCALE_FACTOR, norm999_to_norm1000, norm_to_pixel
from mai_ui_tech.prompt import MAI_MOBILE_SYS_PROMPT_GROUNDING
...
def _should_use_mlx(config: MaiUiConfig) -> bool:
    ...
    if not _mlx_vlm_available():
        return False
    try:
        from mai_ui_tech.mlx_inference import resolve_mlx_model_path
...
class MaiUiGroundingAgent:
    ...
    def _predict_mlx(self, instruction: str, image: Image.Image) -> str:
        from mai_ui_tech.mlx_inference import predict_mlx
