...
# Adapted from Open-AutoGLM phone_agent/config/prompts_zh.py
...
19. 当输入框弹出虚拟数字键盘（如PIN码、支付密码、WiFi密码、金额输入等场景）时，不要使用Type操作。请逐个Tap点击虚拟键盘上的数字/符号按键来输入内容。输入完成后，点击键盘上的确认键（如"完成"、"确定"、"#"、"OK"等按钮）完成输入。"""
)
